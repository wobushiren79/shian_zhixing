...
public class LBSLocalView extends FrameLayout {
	...
	public void loadSpinner(String province, String citys, String street) {
		...
		province_spinner.setSelection(getIndexForArrays(province,
	...
	private void select(Spinner spin, ArrayAdapter<CharSequence> adapter,
		...
		if (spin == city_spinner)
			city_spinner.setSelection(getIndexForArrays(citys, getResources()
					.getStringArray(arry)));
