package com.shian.shianlifezx.common.push;
...
import com.shian.shianlifezx.base.BaseActivity.PushReciver;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (!TextUtils.isEmpty(channelId))
			SharePerfrenceUtils.setShareChannelId(context, channelId);
        Intent in=new Intent();
        in.setAction(PushReciver.C_sPushAction);
