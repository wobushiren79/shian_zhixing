...
public enum APPEnum {
    ...
    MICROMALL("微商城", R.drawable.zhy_myapp_zsproject, "https://kdt.im/AHSojr"),//微商城
    NAVIGATION("导航", R.drawable.zhy_myapp_navigation, "navigation"),//导航
    CALENDAR("万年历", R.drawable.zhy_myapp_calculator, "calendar"),//万年历
    ...
    DIDI("滴滴打车", R.drawable.zhy_myapp_zsproject, "http://webapp.diditaxi.com.cn"),//
