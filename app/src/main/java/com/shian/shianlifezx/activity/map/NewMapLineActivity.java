...
import com.shian.shianlifezx.mapapi.RouteLineAdapter;
import com.shian.shianlifezx.mapapi.overlayutil.DrivingRouteOverlay;
import com.shian.shianlifezx.mapapi.overlayutil.OverlayManager;
import com.shian.shianlifezx.mapapi.overlayutil.TransitRouteOverlay;
import com.shian.shianlifezx.mapapi.overlayutil.WalkingRouteOverlay;
import com.shian.shianlifezx.view.dialog.MapLineChoiceDialog;
        ...
        if (startLatLng != null && endLatLng != null) {
            ...
            if (Utils.isInstalled(NewMapLineActivity.this, "com.baidu.BaiduMap")) {
                try {
                    ...
                    Log.v("this","URISyntaxException : " + e.getMessage());
                    e.printStackTrace();
                }
                ...
                ToastUtils.show(NewMapLineActivity.this, "请先下载百度地图或高德地图");
            }
        } else {
